                ...
                <div className="flex items-center w-full md:w-[60%] flex-col md:flex-row">
                    <nav className="w-full md:w-auto">
                        <ul className="flex gap-[30%] justify-center md:justify-start flex-col md:flex-row">
                            <li className="transition duration-300 hover:-translate-y-2">
                                <a href="/">Home</a>
                            </li>
                            <li className="opacity-75 transition duration-300 hover:-translate-y-2">
                    ...
                    <div className="ml-0 md:ml-[30%] mt-4 md:mt-0">
                        <button
                            ...
                            className="bg-blue-600 px-3 py-1.5 rounded-lg font-bold text-white transition duration-300 hover:-translate-y-2 hover:cursor-pointer"
                        >
                            Ponte en contacto
                        </button>
                    </div>
